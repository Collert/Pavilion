...
class Dish(models.Model):
    ...
    image = models.ImageField(upload_to='heucc_pos/files/dish_images', null=True, blank=True)
    image_cutout = models.ImageField(upload_to='heucc_pos/files/dish_images', null=True, blank=True)
